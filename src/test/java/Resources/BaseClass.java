...
import capabilityReader.CapabilitiesReader;
...
//		
		...
		appiumdriver = new AndroidDriver(new URL(" http://192.168.3.24:4723/"),CapabilitiesReader.getDesiredCapabilities(device, "resources\\Configuration.json"));
